...
INITIAL_PATHS=(/data/xwang3/Projects/agent-medsam/spot_detection/*/preprocessing_func_bank.json)
...
for JSON_PATH in "${JSON_PATHS[@]}"; do
    ...
    python figs/spot_detection_analyze_trajectories.py  --json_path="$JSON_PATH" --gpu_id="$GPU_ID" --data_path='/data/xwang3/sci-agent-data/SpotNet-v1_1' &
