...
INITIAL_PATHS=(medSAM_segmentation/*/preprocessing_func_bank.json)
JSON_PATHS=()
  ...
  for i in "${!JSON_PATHS[@]}"; do
    ...
    if (( i % NUM_GPUS == WORKER_INDEX )); then
      ...
      python figs/medsam_analyze_trajectories.py \
        ...
        --val_data_path='/data/xwang3/sci-agent-data/medsam_data/data/resized_dermoscopy_val_filenames_25.pkl' \
        --test_data_path='/data/xwang3/sci-agent-data/medsam_data/data/resized_dermoscopy_test_filenames_25.pkl'
